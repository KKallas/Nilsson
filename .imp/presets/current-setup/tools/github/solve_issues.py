...
PROMPT_FILE = TOOLS_DIR / "solve_issues.md"
...
def build_prompt(issue: dict) -> str:
    ...
    return f"""You are solving a GitHub issue.

## Issue #{issue['number']}: {issue['title']}

{issue['body']}

Read all target files, execute the steps, verify acceptance criteria, then summarize changes."""


def run_claude(prompt: str, repo_dir: str, issue_number: int, test_mode: bool = False) -> bool:
    """Run Claude on the issue. Tracks token usage to state file."""
...
def process_issue(issue: dict, dry_run: bool = False, test_mode: bool = False) -> bool:
    ...
    try:
        ...
        if not run_claude(prompt, repo_dir, issue['number'], test_mode):
