...
Process: Scans .nilsson/chats/ (and optionally public/logs/) for files,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Clean up Nilsson chat history and logs")
    parser.add_argument(
        "--include-logs",
        action="store_true",
