...
Run: `python tests/test_netguard.py`  (no pytest; exit 0 ok / 1 fail)
"""
...
# enforce: returns quietly for loopback
try:
...
# enforce: aborts (SystemExit non-zero) for the dangerous 0.0.0.0
try:
...
# enforce: aborts for a routable address
try:
